    ...
    <form @submit.prevent="create">
        <div class="grid grid-cols-6 gap-4">
            <div class="col-span-2">
                ...
                <input v-model.number="form.beds" type="number" class="input" />
            ...
            <div class="col-span-2">
                ...
                <input v-model.number="form.baths" type="number" class="block w-full p-2 rounded-md shadow-sm border border-gray-300 dark:border-gray-600 text-gray-500" />
            ...
            <div class="col-span-2">
                ...
                <input v-model.number="form.area" type="number" class="block w-full p-2 rounded-md shadow-sm border border-gray-300 dark:border-gray-600 text-gray-500" />
            ...
            <div class="col-span-6">
                ...
                <input v-model.number="form.price" type="number" class="block w-full p-2 rounded-md shadow-sm border border-gray-300 dark:border-gray-600 text-gray-500" />
